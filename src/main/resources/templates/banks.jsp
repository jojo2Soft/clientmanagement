            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown">
                    <a class="nav-link menu-title link-nav" href="index.html"
                  ...
                  <li class="dropdown">
                    <a
                      class="nav-link menu-title active"
                      href="javascript:void(0)"
                      ><i data-feather="airplay"></i><span>Clients</span></a
                    >
                    <ul class="nav-submenu menu-content" style="display: block">
                      <li>
                        <a href="clients-list.html" class="active">Liste</a>
                      </li>
                      <li><a href="clients-add.html" class="">Ajouter</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
                      ...
                      <div class="table-responsive">
                        <table class="table text-center">
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">1</th>
                              <td>Cotonou <i class="icon-settings"></i></td>
                              <td>
                                <span
                                  class="badge badge-primary counter example-popover"
                                  type="button"
                              ...
                              <td>
                                <span
                                  class="badge badge-warning text-dark counter"
                                  >14</span
                                ><span class="badge badge-info rounded-pill"
                                  >100%</span
                                ><span class="badge badge-info rounded-pill"
                            ...
                            <tr>
                              ...
                              <td>Calavi</td>
                              <td>
                                <span class="badge badge-primary counter"
                                  >14</span
                                ><span class="badge badge-info rounded-pill"
                                  >100%</span
                                >
