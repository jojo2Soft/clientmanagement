                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content"  style="display: block;">
                            ...
                            <li><a href="/clients/add-client-form" class="active">Clients à découvers</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Nombre d'agence</span>
                                    ...
                                    <table class="table text-center">
                                        <thead class="table-primary">
                                            <tr>
                                                ...
                                                <th scope="col">Compte Avec interÃªt</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${banks}" var="bank" varStatus="loop">
                                        
                                            <tr>
                                               <th scope="row">${loop.index + 1}</th>
                                                <td>${bank.capital} <i class="icon-settings"></i></td>
                                                <td><span class="badge badge-primary counter example-popover" type="button" data-bs-trigger="hover" data-container="body" data-bs-toggle="popover" data-bs-placement="bottom" title="Popover title" data-offset="-20px -20px" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">14</span><span class="badge badge-info rounded-pill">100%</span></td>
                                                <td>>${bank.agencies.size()}</td>
                                                <td>>${bank.adresseSiege}</td>
                                            </tr>
