            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown">
                        <a class="nav-link menu-title link-nav " href="/agences/listclients-list.jsp"><i data-feather="git-pull-request"></i><span>Listes des Agences</span></a>
                    </li>
                     <li class="dropdown">
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="row ">
              ...
              <h3>Liste des clients de l'agence ${client.agency.name}</h3>
              
                </div>
                <div class="row">
               		 <a href="/clients/add-client-form" class="btn btn-success col-3">Ajouter un client</a>
 					<a href="/" class="btn btn-primary col-3 mx-4">Retour</a>
                 </div>
                <div class="card">
                  <div class="card-body">
