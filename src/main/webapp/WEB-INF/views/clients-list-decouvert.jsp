                ...
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="nav-submenu menu-content" style="display: block">
                      <li>
                        <a href="/agences/clients" class="active">Listes</a>
                      </li>
                      <li>
                         <li><a href="/clients/list/decoucouvert" class="active">Clients à découvert</a></li>
                      </li>
                    </ul>
                  </li>
                </ul>
                        ...
                        <tbody>
                          <c:forEach items="${clients}" var="client" varStatus="loop">
                            <tr>
                              ...
                              <td><a href="" class="btn btn-success">Consulter le soldes des comptes</a></td>
                            </tr>
                          </c:forEach>
                        </tbody>
                      </table>
