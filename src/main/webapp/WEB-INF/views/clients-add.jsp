                ...
                <ul class="nav-menu custom-scrollbar">
                   ...
                   <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content"  style="display: block;">
                            ...
                            <li><a href="/clients/add-client-form" class="active">Ajouter</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="container-fluid">
           ...
           <div class="col-sm-12">
            <div class="card">
                ...
                <c:url var="save_client_url" value="/clients/add"/>
                <form:form action="${save_client_url}" class="form theme-form" method="post" modelAttribute="client">
                    <div class="card-body">
                        <div class="row">
                          
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <form:label path="firstname" for="exampleFormControlInput15" class="form-label">Nom: </form:label> 
                                    <form:input class="form-control input-air-primary" type="text" path="firstname"/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <form:label path="lastname" for="exampleFormControlInput15" class="form-label">Prénoms: </form:label> 
                                    <form:input class="form-control input-air-primary" type="text" path="lastname"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <form:label path="number" for="exampleFormControlInput15" class="form-label">number: </form:label> 
                                    <form:input class="form-control input-air-primary" type="text" path="number"/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <form:label path="adress" for="exampleFormControlInput15" class="form-label">Adresse: </form:label> 
                                    <form:input class="form-control input-air-primary" type="text" path="adress"/>
                                </div>
                            </div>
                        </div>
                         <div class="row">
						...
						<div class="col-sm-6">
                                <div class="mb-3">
                                   <form:label path="nameAdvisor" for="exampleFormControlInput15" class="form-label">Choisir l'agence: </form:label> 
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <form:label path="nameAdvisor" for="exampleFormControlInput15" class="form-label">Nom et prénom du superviseur: </form:label> 
                                    <form:input class="form-control input-air-primary" type="text" path="nameAdvisor"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <a class="btn btn-warning" href="/agences/clients" type="submit">Annuler</a>
